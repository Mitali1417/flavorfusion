        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/search"
                className="group border-2 text-primary px-8 py-4 rounded-full font-semibold backdrop-blur-sm transition-all duration-500 hover:scale-105 flex items-center justify-center gap-2"
              >
