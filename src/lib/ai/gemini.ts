...
export async function generateAIRecipe({ ingredients, preferences }: AIRecipeRequest): Promise<AIRecipeResponse | null> {
  ...
  try {
    ...
    // The API returns the result in a nested structure, extract the JSON from the text
