export const styles = {
    ...
    input:'px-[0.75rem] py-[0.25rem] rounded-full focus:outline-shade3 text-shade1',
    btn:'px-[0.75rem] py-[0.25rem] bg-black rounded-[0.50rem] text-white hover:border-[0.10rem] hover:border-white hover:bg-black/60 transition ease-in-out duration-500 hover:scale-105 ',
    btn2:'px-[0.9rem] py-[0.39rem] bg-gradient-to-tr from-shade1 to-shade4 hover:bg-gradient-to-tr hover:from-[#343655] hover:to-[#cb785f] rounded-[0.50rem] text-white font-OpenSans font-semibold text-[0.9rem] transition ease-in-out duration-500',
    btn3:'px-[1rem] py-[0.39rem] backdrop-blur-2xl bg-white hover:bg-[#343655] hover:text-white text-black rounded-[0.50rem] font-OpenSans font-semibold text-[0.9rem] transition ease-in-out duration-500 ',
