export const styles = {
    ...
    btn:'px-[0.9rem] py-[0.39rem] text-[0.9rem] bg-black rounded-[0.50rem] text-white hover:bg-[#333333] transition ease-in-out duration-500 ',
    ...
    paddingY:'py-[2rem]',
    marginX:'mx-[2rem] md:mx-[4rem] xl:mx-[8rem]',
    marginY:'my-[2rem]',
}