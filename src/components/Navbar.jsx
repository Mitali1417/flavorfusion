...
const Navbar = (props) => {
  ...
  return (
    <>
      <div
        className={`${styles.flexCenter} justify-between ${styles.paddingX} fixed z-10 top-[0.6rem] left-[4rem] right-[4rem] py-[1.2rem] rounded-full bg-black/50 backdrop-blur-lg `}
      >
